import { AppId, Result, SteamId, WebApiKey } from "../core/steamWebApi"
 ...
 * @property achieved Integer to be used as a boolean value indicating whether the achievement has been unlocked
 *           by the user.
